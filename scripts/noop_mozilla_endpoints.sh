...
noop_mozilla_endpoints "discovery.addons.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "discovery.addons.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "discovery.addons-dev.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "anf1.fuzzing.mozilla.org" "${mozilla_release}/browser"
...
## Connectivity checks
noop_mozilla_endpoints "detectportal.firefox.com" "${mozilla_release}/browser"
...
## Contile
noop_mozilla_endpoints "contile.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "contile-images.services.mozilla.com" "${mozilla_release}/browser"
...
## Crash reporting
noop_mozilla_endpoints "crash-reports.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-reports.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-reports-xpsp2.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-stacks.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-stats.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-stats.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "crash-stats.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "socorro.prod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "socorro-collector.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "socorro-webapp.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "socorro-webapp-allizom.stage.mozaws.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "talkback.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "talkback-public.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "talkback-reports.mozilla.org" "${mozilla_release}/browser"
...
## DoH canary requests
noop_mozilla_endpoints "sitereview.zscaler.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "use-application-dns.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "firefox-dns-perf-test.net" "${mozilla_release}/browser"
...
## GeoIP
noop_mozilla_endpoints "classify-client.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "location.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "locprod1-elb-eu-west-1.prod.mozaws.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "locprod2-elb-us-west-2.prod.mozaws.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "nonprod.classify-client.nonprod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod.classify-client.prod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "search.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "search.services.mozilla.com" "${mozilla_release}/browser"
...
## Icons
noop_mozilla_endpoints "activity-stream-icons.services.mozilla.com" "${mozilla_release}/browser"
...
## MARS
noop_mozilla_endpoints "ads.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "ads.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "ads.nonprod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "ads-img.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "tiles-cdn.prod.ads.prod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "normandy.cdn.mozilla.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "normandy.nonprod.cloudops.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "normandy-cdn.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod-classifyclient.normandy.prod.cloudops.mozgcp.net" "${mozilla_release}/browser"
...
## Pocket
noop_mozilla_endpoints "firefox-android-home-recommendations.getpocket.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "img-getpocket.cdn.mozilla.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "spocs.getpocket.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "spocs.getpocket.dev" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "spocs.mozilla.net" "${mozilla_release}/browser"
...
## Sentry
noop_mozilla_endpoints "5cfe351fb3a24e8d82c751252b48722b@o1069899.ingest.sentry.io" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "o1069899.ingest.sentry.io" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod.sentry.prod.cloudops.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "sentry.io" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "stage.sentry.nonprod.cloudops.mozgcp.net" "${mozilla_release}/browser"
...
## Snippets
noop_mozilla_endpoints "snippets.allizom.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets.cdn.mozilla.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets-prod.frankfurt.moz.works" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets-prod.moz.works" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets-prod.oregon-b.moz.works" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets-stage.moz.works" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "snippets-stage.oregon-b.moz.works" "${mozilla_release}/browser"
...
## Surveys
noop_mozilla_endpoints "survey.mozilla.com" "${mozilla_release}/browser"
...
## Telemetry
noop_mozilla_endpoints "coverage.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "dap-09-3.api.divviup.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "dap.nonprod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "dap.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "debug-ping-preview.firebaseapp.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "download-stats.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "download-stats.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "fhr.data.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "fhr.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "incoming.glean.example.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "incoming.telemetry.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "incoming.thunderbird.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "incoming-telemetry.thunderbird.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod.dap.prod.webservices.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod.data-ingestion.prod.dataops.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "prod.ingestion-edge.prod.dataops.mozgcp.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "self-repair.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "self-repair.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-coverage.mozilla.org" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-coverage.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-experiment.cdn.mozilla.net" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-incoming.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-incoming-a.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
noop_mozilla_endpoints "telemetry-incoming-b.r53-2.services.mozilla.com" "${mozilla_release}/browser"
...
## Top Sites
noop_mozilla_endpoints "topsites.services.mozilla.com" "${mozilla_release}/browser"
